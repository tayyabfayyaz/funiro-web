...
function HeroSection(){
    return(
        <>
        <section className="hero_container w-full md:w-full lg:max-w-[1440px] xl:max-w-[1440px] h-screen block md:block lg:flex xl:flex items-center justify-end">
            ...
            <div className="inner_container w-full md:w-full lg:w-[640px] xl:w-[640px] h-[440px] bg-customPink mr-12 py-10 px-3 md:px-3 lg:px-2 xl:px-12 shadow-lg shadow-gray-400">
                ...
                <Button text="Buy Now" onClick={ () => alert("Clicked!!") } className="mt-10 py-3 px-6 bg-customBrown text-white text-[16px] font-bold" />
            </div>
        </section>
        </>
    );
